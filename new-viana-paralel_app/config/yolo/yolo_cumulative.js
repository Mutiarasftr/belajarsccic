...
class YOLO{
    ...
    init(simulationMode, videoParams, port, transId){
        ...
        if(!this.simulationMode){
            ...
            let endCommand = ['-garis','1','-count_static','1', '-mjpeg_port', port, "-dont_show", '-transId', transId];
            ...
            this.process = new (forever.Monitor)(darknetCommand,{
                max: 1,
                cwd: config.PATH_TO_YOLO_DARKNET_CUMULATIVE,
                killTree: true,
                silent: false,
            });
